...
public class UsuarioDAO {
    ...
    */
    ...
    public int agregarUsuarios(Usuario user) {
        ...
        int r = 0;
        String sql = "INSERT INTO Usuario(nombre, apellido1, apellido2, email, nombreUsuario, tipoUsuario, password, activo) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public int actualizarUsuario(Usuario user) {
        ...
        int r = 0;
        String sql = "UPDATE Usuario set nombre=?, apellido1=?, apellido2=?, email=?, nombreUsuario=?, tipoUsuario=?, password=?, activo=?  WHERE idUsuario=?";
    ...
    public void filtrarTablaPorNombre(JTable tabla, String filtro) {
        ...
        String[] titulos = {"idUsuario", "nombre", "apellido1", "apellido2", "email", "nombreUsuario", "tipoUsuario", "password", "activo"};
    ...
    public boolean login(Usuario user) {
        ...
        String sql = "SELECT idUsuario, nombreUsuario, password, tipoUsuario FROM Usuario WHERE idUsuario=?";
