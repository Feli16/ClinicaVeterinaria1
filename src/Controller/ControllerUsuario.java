        ...
        if (e.getSource() == vistaUsuario.btnEditar) {
            if (vistaUsuario.txtidUsuario.getText().isEmpty()) {
               JOptionPane.showMessageDialog(vistaUsuario, "Debe seleccionar un registro en la tabla");
                ...
                JOptionPane.showMessageDialog(vistaUsuario, "Debe ingresar el nombre");
            } else if (vistaUsuario.txtEmailUsuario.getText().isEmpty()) {
                JOptionPane.showMessageDialog(vistaUsuario, "Debe ingresar el correo electronico");
            } else if (vistaUsuario.txtNombreUsuario.getText().isEmpty()) {
                JOptionPane.showMessageDialog(vistaUsuario, "Debe ingresar el nombre de usuario");
            } else {
                actualizarUsuario();
            }
